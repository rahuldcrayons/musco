<x-layouts.app>
    ...
    @push('meta')
        <meta name="description" content="Exclusive offers and deals at Jikra. Navratri 5% extra off, video review cashback, and more!">
        <link rel="canonical" href="{{ url('/offers') }}">
    @endpush

    <div class="bg-white min-h-screen">
        <!-- Hero Banner -->
        <div class="relative overflow-hidden" style="background: linear-gradient(135deg, #FF6B35 0%, #FF9F1C 50%, #F7C948 100%);">
            ...
            <div class="container mx-auto px-4 py-12 lg:py-16 text-center relative z-10">
                ...
                <p class="text-white/90 text-sm lg:text-base max-w-lg mx-auto">Grab the best deals on Jikra products. Limited time offers you don't want to miss!</p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 py-10 lg:py-14">
            <div class="grid gap-8 lg:gap-10 max-w-4xl mx-auto">
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg border border-orange-100">
                    <div class="p-1" style="background: linear-gradient(135deg, #FF6B35, #FF9F1C);">
                        <div class="bg-white rounded-xl p-6 lg:p-8">
                            <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                                <div class="flex-shrink-0 w-20 h-20 lg:w-24 lg:h-24 rounded-2xl flex items-center justify-center text-4xl lg:text-5xl" style="background: linear-gradient(135deg, #FFF3E0, #FFE0B2);">
                                    🎉
                                </div>
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 mb-2">
                                        <span class="px-3 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider text-white" style="background: linear-gradient(135deg, #FF6B35, #FF9F1C);">Live Now</span>
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#0F1111] mb-2">Navratri Special - Extra 5% Off</h2>
                                    <p class="text-sm text-[#565959] mb-3">Celebrate Navratri with Jikra! Get <strong>flat 5% extra discount</strong> on your entire order, applied automatically at checkout after all other discounts. No coupon needed!</p>
                                    <ul class="text-xs text-[#565959] space-y-1 mb-4">
                                    ...
                                    <a href="{{ route('products.index') }}" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-bold text-white transition-all hover:scale-105" style="background: linear-gradient(135deg, #FF6B35, #FF9F1C);">
                                        Shop Now
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg border border-blue-100">
                    <div class="p-1" style="background: linear-gradient(135deg, #205258, #2d7a85);">
                        <div class="bg-white rounded-xl p-6 lg:p-8">
                            <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 mb-2">
                                        <span class="px-3 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider text-white bg-[#205258]">Cashback</span>
                                        <span class="px-3 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-yellow-100 text-yellow-700">₹100 Reward</span>
                                    </div>
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#0F1111] mb-2">Share a Video, Get ₹100 Cashback!</h2>
                                    <p class="text-sm text-[#565959] mb-3">Already have a Jikra product? Make a short video review showing how you use it and send it to us. We'll give you <strong>₹100 cashback</strong> directly to your account!</p>

                                    <div class="bg-[#f8f6f3] rounded-xl p-4 mb-4">
                                        <h3 class="text-sm font-bold text-[#0F1111] mb-3">How it works:</h3>
                                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            <div class="text-center">
                                                <div class="w-10 h-10 rounded-full bg-[#205258] text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">1</div>
                                                <p class="text-xs text-[#565959]">Record a <strong>30-60 sec video</strong> of your Jikra product in use</p>
                                            </div>
                                            <div class="text-center">
                                                <div class="w-10 h-10 rounded-full bg-[#205258] text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">2</div>
                                                <p class="text-xs text-[#565959]">Send the video to us on <strong>WhatsApp</strong> or <strong>Instagram DM</strong></p>
                                            </div>
                                            <div class="text-center">
                                                <div class="w-10 h-10 rounded-full bg-[#205258] text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">3</div>
                                                <p class="text-xs text-[#565959]">Get <strong>₹100 cashback</strong> in your bank/UPI within 48 hours</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="text-xs text-[#565959] space-y-1 mb-4">
                                        ...
                                        <li class="flex items-center gap-2"><svg class="w-4 h-4 text-green-500 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg> Video must show the actual Jikra product</li>
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        <a href="https://wa.me/919996306909?text=Hi%20Jikra!%20I%20want%20to%20share%20a%20video%20review%20of%20my%20product%20for%20the%20%E2%82%B9100%20cashback%20offer." target="_blank" rel="noopener"
                                        ...
                                        <a href="https://www.instagram.com/jikraoffical/" target="_blank" rel="noopener"
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg border border-green-100">
                    <div class="p-1 bg-gradient-to-r from-green-500 to-emerald-500">
                        <div class="bg-white rounded-xl p-6 lg:p-8">
                            <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#0F1111] mb-2">Free Shipping on Orders Above ₹499</h2>
                                    <p class="text-sm text-[#565959] mb-3">No hidden shipping charges! All orders above ₹499 ship free across India. COD available with just ₹100 advance payment.</p>
                    ...
                    <div class="p-1 bg-gradient-to-r from-purple-500 to-indigo-500">
                        <div class="bg-white rounded-xl p-6 lg:p-8">
                            <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                                ...
                                <div class="flex-1">
                                    <h2 class="text-xl lg:text-2xl font-bold text-[#0F1111] mb-2">7-Day Easy Returns</h2>
                                    <p class="text-sm text-[#565959] mb-3">Not satisfied? Return any product within 7 days of delivery. No questions asked. We'll process your refund within 3-5 business days.</p>
