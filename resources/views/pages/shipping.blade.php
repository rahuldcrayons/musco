    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8 sm:mb-10">
                <div class="w-14 h-14 mx-auto rounded-full bg-[#202a40]/5 flex items-center justify-center mb-4">
            ...
            <div class="mb-8">
                <p class="text-xs font-semibold text-[#202a40] uppercase tracking-wider pb-3">Delivery Options</p>
                <div class="grid sm:grid-cols-2 gap-3">
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            <div class="w-9 h-9 rounded-lg bg-[#202a40]/5 flex items-center justify-center shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-neutral-600 mt-0.5">{{ \App\Models\Setting::get('standard_delivery_days', '5-7') }} business days</p>
                                <p class="text-sm font-bold text-[#202a40] mt-1.5">FREE on orders above {{ currency_symbol() }}{{ \App\Models\Setting::get('free_shipping_threshold', 499) }}</p>
                                <p class="text-[11px] text-neutral-600 mt-0.5">{{ currency_symbol() }}{{ \App\Models\Setting::get('below_threshold_shipping_cost', 49) }} for orders below {{ currency_symbol() }}{{ \App\Models\Setting::get('free_shipping_threshold', 499) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-neutral-600 mt-0.5">{{ \App\Models\Setting::get('express_delivery_days', '2-3') }} business days</p>
                                <p class="text-sm font-bold text-neutral-900 mt-1.5">{{ currency_symbol() }}{{ \App\Models\Setting::get('express_shipping_cost', 99) }}</p>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-neutral-600 mt-0.5">Order before {{ \App\Models\Setting::get('sameday_cutoff_hour', 12) }} PM</p>
                                <p class="text-sm font-bold text-neutral-900 mt-1.5">{{ currency_symbol() }}{{ \App\Models\Setting::get('sameday_shipping_cost', 149) }}</p>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-neutral-900">Payment Options</h3>
                                ...
                                <p class="text-[11px] text-neutral-600 mt-0.5">On orders up to £500</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <p class="text-xs font-semibold text-[#202a40] uppercase tracking-wider pt-2 pb-1">Order Processing</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 1" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">Orders are typically dispatched within {{ \App\Models\Setting::get('dispatch_time', '24 hours') }} of being placed on business days. Orders placed on weekends/holidays will be processed the next business day.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div x-show="open === 2" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            ...
                            <ul class="mt-2 space-y-1 list-disc list-inside text-neutral-600">
                                ...
                                <li>Use our <a href="{{ route('track-order') }}" class="text-[#202a40] hover:text-[#222222] font-medium">order tracking page</a></li>
                ...
                <p class="text-xs font-semibold text-[#202a40] uppercase tracking-wider pt-4 pb-1">Delivery Details</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 3" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">We deliver across the United Kingdom. Standard delivery typically takes 3-5 business days. Remote areas may take 1-2 additional business days.</p>
                        </div>
                    </div>
                </div>
                ...
                <p class="text-xs font-semibold text-[#202a40] uppercase tracking-wider pt-4 pb-1">Issues & Support</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 7" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">Some oversized items or bundled sets may have shipping restrictions to certain areas. You will be notified at checkout if any items in your cart cannot be shipped to your location.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 bg-white border border-neutral-100 rounded-xl p-6 sm:p-8 text-center">
                <div class="w-11 h-11 mx-auto rounded-full bg-[#202a40]/5 flex items-center justify-center mb-3">
                ...
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center px-4 py-2 bg-[#202a40] text-white text-sm font-semibold rounded-xl transition-colors">
                    Contact Support
                </a>
            </div>
        </div>
