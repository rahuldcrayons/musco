            ...
            <div class="max-w-3xl mx-auto text-center bg-gradient-to-br from-[#F8931D] via-[#F8931D] to-[#D47200] rounded-2xl p-8 sm:p-12 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        <a href="{{ route('categories.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-[#1b454a] text-sm font-semibold rounded-lg hover:bg-[#205258]/5 transition-colors shadow-lg">
                            Shop Now
