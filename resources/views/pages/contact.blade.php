<x-layouts.app>
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-6xl mx-auto">
            ...
            <!-- Success Message -->
            @if(session('success'))
                <div class="mb-6 p-4 bg-[#B76E79]/5 border border-[#B76E79]/20 rounded-xl flex items-start gap-3">
                    <svg class="w-5 h-5 text-[#B76E79] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <p class="text-sm text-[#B76E79]">{{ session('success') }}</p>
                </div>
            @endif
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-7 h-full">
                        ...
                        <form action="{{ route('contact.send') }}" method="POST" class="flex flex-col h-[calc(100%-2rem)] space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="name" class="block text-sm font-medium text-neutral-700 mb-1.5">Your Name <span class="text-[#CC0C39]">*</span></label>
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                           class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#B76E79]/20 focus:border-[#B76E79] transition-all @error('name') border-[#CC0C39]/30 bg-[#CC0C39]/5 @enderror"
                                ...
                                <div>
                                    <label for="email" class="block text-sm font-medium text-neutral-700 mb-1.5">Email Address <span class="text-[#CC0C39]">*</span></label>
                                    <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                           class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#B76E79]/20 focus:border-[#B76E79] transition-all @error('email') border-[#CC0C39]/30 bg-[#CC0C39]/5 @enderror"
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" id="subject" value="{{ old('subject') }}" required
                                       class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#B76E79]/20 focus:border-[#B76E79] transition-all @error('subject') border-[#CC0C39]/30 bg-[#CC0C39]/5 @enderror"
                            ...
                            <div class="flex-1">
                                ...
                                <textarea name="message" id="message" rows="6" required
                                          class="w-full h-[calc(100%-1.75rem)] min-h-[140px] px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#B76E79]/20 focus:border-[#B76E79] transition-all resize-none @error('message') border-[#CC0C39]/30 bg-[#CC0C39]/5 @enderror"
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-9 h-9 bg-[#B76E79]/5 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                                ...
                                <div>
                                    ...
                                    <p class="text-[13px] text-neutral-600 leading-relaxed">{!! nl2br(e(\App\Models\Setting::get('company_address', 'MusCo, G118 Deep Vihar, Rohini Sector 24, Delhi 110084'))) !!}</p>
                                </div>
                            </div>
                    ...
                    <!-- Google Map -->
                    @php $mapEmbed = \App\Models\Setting::get('google_maps_embed', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.574!2d77.0567!3d28.7365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d0147e1c5b2c3%3A0x0!2sDeep+Vihar%2C+Rohini+Sector+24%2C+Delhi!5e0!3m2!1sen!2sin!4v1700000000000'); @endphp
                    @if($mapEmbed)
