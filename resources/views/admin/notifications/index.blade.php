                        ...
                        <div class="mt-0.5">
                            @switch($notification->type)
                                ...
                                @case('payment')
                                    ...
                                    @break
                                @case('review')
                                    <div class="w-8 h-8 rounded-full bg-[#c29958]/10 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-[#c29958]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
