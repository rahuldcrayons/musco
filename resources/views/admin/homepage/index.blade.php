<x-layouts.admin>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <a href="{{ route('admin.homepage.about-settings') }}" class="bg-white p-5 flex items-center gap-4 hover:shadow-md transition-shadow" style="border-radius:12px;border:1px solid #e3e3e3">
            <div class="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style="background:#f4f4f4">
                <svg class="w-5 h-5 text-neutral-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/></svg>
            </div>
            <div>
                <p class="text-sm font-semibold text-neutral-900">About Page</p>
                <p class="text-xs text-neutral-500">Content, images, FAQ</p>
            </div>
        </a>
    </div>
