        ...
        <div x-show="!loading && reels.length > 0" x-cloak class="ig-shop-carousel" x-data="{ scrollEl: null }" x-init="scrollEl = $refs.track">
            <div class="ig-shop-track" x-ref="track">
                <template x-for="reel in reels" :key="reel.shortcode">
                    <div class="ig-shop-item">
                        <a :href="'/reels/' + reel.shortcode" class="ig-shop-thumb group">
                            ...
                            <div x-show="!reel.thumbnail_url" class="ig-shop-placeholder"></div>
...
<style>
    ...
    .ig-shop-thumb img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.3s; }
    .ig-shop-thumb:hover img { transform: scale(1.05); }
    .ig-shop-placeholder { width: 100%; height: 100%; background: linear-gradient(135deg, #205258, #1b454a); }
    .ig-shop-overlay {
