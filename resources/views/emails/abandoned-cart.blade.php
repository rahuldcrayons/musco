...
<span style="font-family:Outfit,sans-serif; color:#202a40; font-size:24px; font-weight:700; letter-spacing:-0.02em;">Mus<span style="color:#2b2b2b;">Co</span></span>
</td></tr>

<tr><td style="background:#202a40;padding:20px;text-align:center;">
...
<div style="background:rgba(183,110,121,0.08);border:2px dashed #202a40;border-radius:8px;padding:16px;text-align:center;margin:20px 0;">
<p style="margin:0 0 4px;font-size:12px;color:#888;">EXCLUSIVE OFFER - JUST FOR YOU</p>
<p style="margin:0;font-size:28px;font-weight:bold;color:#202a40;">5% OFF</p>
...
<a href="{{ $cartUrl }}" style="background:#202a40;color:#fff;text-decoration:none;padding:14px 40px;border-radius:6px;font-size:15px;font-weight:600;display:inline-block;">Complete Your Order</a>
</div>

<p style="font-size:11px;color:#999;text-align:center;">Need help? Reply to this email or WhatsApp +44 7459914080</p>
</td></tr>

<tr><td style="background:#222222;padding:12px 20px;text-align:center;">
<p style="color:#7a9a9e;font-size:10px;margin:0;">&copy; {{ date('Y') }} Trendymus. All rights reserved.</p>
</td></tr>
