    ...
    <div class="bg-[#f8f6f3] min-h-screen">
        ...
        <div class="bg-[#205258] py-8 lg:py-12">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-2xl lg:text-3xl font-bold text-white mb-2">Reels & Videos</h1>
                <p class="text-white/70 text-sm max-w-md mx-auto">Watch our latest videos and shop the products you love</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-6">
                    @foreach($reels as $reel)
                        <a href="{{ route('reels.show', $reel['shortcode']) }}" class="group block">
                            <div class="relative rounded-2xl overflow-hidden bg-[#f0f0f0] shadow-sm group-hover:shadow-md transition-shadow" style="aspect-ratio: 9/16;">
                                ...
                                <div class="absolute bottom-3 left-3 right-3">
                                    <div class="bg-white/95 backdrop-blur rounded-lg px-3 py-2 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
                                        <span class="text-xs font-semibold text-[#205258]">Watch & Shop</span>
