...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-primary { background: #202a40; color: #fff; }
        ...
        .badge-success { background: rgba(183,110,121,0.1); color: #202a40; }
        .badge-warning { background: rgba(194,153,88,0.1); color: #506282; }
        .badge-error { background: rgba(204,12,57,0.1); color: #CC0C39; }
        .badge-dot { width: 6px; height: 6px; border-radius: 50%; display: inline-block; }
        .badge-success .badge-dot { background: #202a40; }
        .badge-warning .badge-dot { background: #506282; }
    ...
    <div class="invoice">
        ...
        <div class="header">
            <div class="header-left">
                <img src="{{ asset('images/mus-removebg-preview.png') }}" alt="{{ config('app.name') }}" style="height:48px; width:auto; flex-shrink:0;">
                <div>
        ...
        {{-- Footer --}}
        <div class="footer">
            <div class="footer-thanks" style="display:flex; align-items:center; justify-content:center; gap:8px;">
                Thank you for shopping with <img src="{{ asset('images/mus-removebg-preview.png') }}" alt="{{ config('app.name') }}" style="height:22px; width:auto; vertical-align:middle;">!
            </div>
        </div>
    </div>
</body>
