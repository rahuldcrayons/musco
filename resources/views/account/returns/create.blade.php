                        ...
                        <form action="{{ route('account.returns.store') }}" method="POST"
                            ...
                            <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
                                <div class="px-5 py-3 border-b border-neutral-100 flex items-center gap-2">
                                    <span class="w-5 h-5 bg-[#B76E79] text-white text-[11px] font-bold rounded-full flex items-center justify-center">1</span>
                                    ...
                                    <div class="grid gap-2">
                                        @foreach($orders as $order)
                                            <label @click="selectedOrder = '{{ $order->id }}'; selectedItems = []"
                                                   :class="selectedOrder == '{{ $order->id }}' ? 'border-[#B76E79]/50 bg-[#B76E79]/5 ring-1 ring-[#B76E79]/30' : 'border-neutral-200 hover:border-neutral-300 bg-white'"
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div :class="selectedOrder == '{{ $order->id }}' ? 'border-[#B76E79] bg-[#B76E79]' : 'border-neutral-300'"
                            ...
                            <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
                                <div class="px-5 py-3 border-b border-neutral-100 flex items-center gap-2">
                                    <span class="w-5 h-5 bg-[#B76E79] text-white text-[11px] font-bold rounded-full flex items-center justify-center">2</span>
                                    <h2 class="text-sm font-bold text-neutral-900">Return Type</h2>
                                </div>
                                <div class="p-5">
                                    <div class="grid grid-cols-2 gap-3">
                                        <label @click="type = 'return'"
                                               :class="type === 'return' ? 'border-[#B76E79]/50 bg-[#B76E79]/5 ring-1 ring-[#B76E79]/30' : 'border-neutral-200 hover:border-neutral-300'"
                                            ...
                                            <div class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0"
                                                 :class="type === 'return' ? 'bg-[#B76E79]/10 text-[#B76E79]' : 'bg-neutral-100 text-neutral-600'">
                                        ...
                                        <label @click="type = 'exchange'"
                                               :class="type === 'exchange' ? 'border-[#B76E79]/50 bg-[#B76E79]/5 ring-1 ring-[#B76E79]/30' : 'border-neutral-200 hover:border-neutral-300'"
                                               class="flex items-center gap-3 p-3.5 rounded-lg border cursor-pointer transition-all">
                                            <input type="radio" name="type" value="exchange" x-model="type" class="sr-only">
                                            <div class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0"
                                                 :class="type === 'exchange' ? 'bg-[#B76E79]/10 text-[#B76E79]' : 'bg-neutral-100 text-neutral-600'">
                            ...
                            <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
                                <div class="px-5 py-3 border-b border-neutral-100 flex items-center gap-2">
                                    <span class="w-5 h-5 bg-[#B76E79] text-white text-[11px] font-bold rounded-full flex items-center justify-center">3</span>
                                    <h2 class="text-sm font-bold text-neutral-900">Reason for Return</h2>
                                </div>
                                <div class="p-5 space-y-3">
                                    <select name="reason" required class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#B76E79]/50 focus:ring focus:ring-[#B76E79]/15 focus:ring-opacity-50">
                                    ...
                                    <textarea name="description" rows="2" placeholder="Additional details (optional)"
                                              class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#B76E79]/50 focus:ring focus:ring-[#B76E79]/15 focus:ring-opacity-50 resize-none">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="text-sm text-[#CC0C39]">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden" x-show="currentOrder" x-cloak>
                                <div class="px-5 py-3 border-b border-neutral-100 flex items-center gap-2">
                                    <span class="w-5 h-5 bg-[#B76E79] text-white text-[11px] font-bold rounded-full flex items-center justify-center">4</span>
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="space-y-2">
                                        <template x-for="(item, idx) in currentOrder?.items || []" :key="item.id">
                                            <div :class="isSelected(item.id) ? 'border-[#B76E79]/50 bg-[#B76E79]/5/30 ring-1 ring-[#B76E79]/30' : 'border-neutral-200'"
                                                ...
                                                <div @click="toggleItem(item.id)" class="flex items-center gap-3 p-3.5 cursor-pointer">
                                                    <div :class="isSelected(item.id) ? 'bg-[#B76E79] border-[#B76E79]' : 'border-neutral-300'"
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2 focus:border-[#B76E79]/50 focus:ring focus:ring-[#B76E79]/15 focus:ring-opacity-50">
                                                        </div>
