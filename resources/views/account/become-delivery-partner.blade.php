    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1" x-data="{
                ...
                {{-- Header --}}
                <div class="rounded-xl p-5 sm:p-6 mb-6 bg-gradient-to-r from-[#B76E79]/50 to-[#B76E79] text-white">
                ...
                <div class="flex items-center gap-0 mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors"
                             :class="currentStep >= 1 ? (currentStep > 1 ? 'bg-success-500 text-white' : 'bg-[#B76E79] text-white') : 'bg-neutral-200 text-neutral-600'">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors"
                             :class="currentStep >= 2 ? (currentStep > 2 ? 'bg-success-500 text-white' : 'bg-[#B76E79] text-white') : 'bg-neutral-200 text-neutral-600'">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors"
                             :class="currentStep >= 3 ? 'bg-[#B76E79] text-white' : 'bg-neutral-200 text-neutral-600'">
                            <span>3</span>
                        </div>
                        ...
                        <form action="{{ route('account.become-delivery-partner.store') }}" method="POST">
                            ...
                            <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="phone" id="phone" value="{{ old('phone', auth()->user()->phone) }}" required
                                                   class="w-full px-3 py-2.5 bg-neutral-50 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:border-[#B76E79] focus:ring-0 transition-colors"
                                ...
                                <div class="px-5 py-4 bg-neutral-50 border-t border-neutral-100 flex items-center justify-end">
                                    <button type="submit" class="px-4 py-2 bg-[#B76E79] hover:bg-[#222222] text-white font-semibold rounded-lg text-sm transition-colors inline-flex items-center gap-2">
                ...
                <div x-show="currentStep === 2" x-cloak>
                            ...
                            <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                                ...
                                <div class="p-5 space-y-5">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <label class="flex items-center justify-center gap-2 w-full px-4 py-3 border-2 border-dashed border-neutral-300 rounded-lg cursor-pointer hover:border-[#c29958] hover:bg-[#c29958]/5/50 transition-colors">
                    ...
                    @else
                        <div class="bg-white border border-neutral-100 rounded-xl p-6 text-center">
                            ...
                            <button @click="currentStep = 1" class="mt-3 text-sm text-[#B76E79] hover:text-[#222222] font-medium">Go to Step 1</button>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                            <div class="p-6 sm:p-8 text-center">
                                @if($partner->verification_status === 'verified')
                                    ...
                                    <a href="{{ route('delivery.login') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#B76E79] hover:bg-[#222222] text-white font-semibold rounded-lg text-sm transition-colors">
                                ...
                                @elseif($partner->verification_status === 'rejected')
                                    ...
                                    <button @click="currentStep = 2" class="inline-flex items-center gap-2 px-4 py-2 bg-[#B76E79] hover:bg-[#222222] text-white font-semibold rounded-lg text-sm transition-colors">
                                ...
                                @else
                                    {{-- Pending --}}
                                    <div class="w-16 h-16 bg-[#c29958]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <svg class="w-8 h-8 text-[#c29958]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                    </div>
                                    <h2 class="text-lg font-bold text-[#c29958] mb-1">Under Review</h2>
                                    <p class="text-sm text-neutral-600 mb-1">Partner ID: <strong>{{ $partner->partner_id }}</strong></p>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                                        <button @click="currentStep = 2" class="text-sm text-[#B76E79] hover:text-[#222222] font-medium inline-flex items-center gap-1.5">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                            Update Documents
                                        </button>
                                    </div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium capitalize
                                            {{ $partner->verification_status === 'verified' ? 'text-success-600' : ($partner->verification_status === 'rejected' ? 'text-error-600' : 'text-[#c29958]') }}">
