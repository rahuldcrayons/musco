    ...
    <div class="h-screen flex overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 py-6 lg:py-8 relative overflow-y-auto"
            ...
            <div class="w-full max-w-md mx-auto">
                <!-- Back to home link -->
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-sm text-neutral-600 hover:text-[#0f2a2e] transition-colors group mb-6 mt-2">
                ...
                <div class="relative"
                    ...
                    <div x-show="mode === 'login'" x-cloak:remove>
                        ...
                        <div class="mb-5">
                            ...
                            <p class="text-neutral-600 text-sm">Sign in to access your account</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-4">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <a href="{{ route('password.request') }}" class="text-sm text-[#0f2a2e] hover:text-[#091c1f] font-medium transition-colors">
                                        Forgot password?
                                    </a>
                                </div>
                            ...
                            <div class="flex items-center">
                                <label class="relative flex items-center cursor-pointer">
                                    ...
                                    <div class="w-5 h-5 border-2 border-neutral-500 rounded-md peer-checked:bg-[#F8931D] peer-checked:border-[#0f2a2e] transition-all flex items-center justify-center">
                        ...
                        <p class="mt-5 text-center text-sm text-neutral-600">
                            ...
                            <button @click="switchTo('register')" class="font-semibold text-[#0f2a2e] hover:text-[#091c1f] transition-colors">
                                Create an account
                            </button>
                        </p>
                    </div>
                    ...
                    <div x-show="mode === 'register'" x-cloak>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-4">
                            ...
                            <div class="flex items-start pt-1">
                                <label class="relative flex items-start cursor-pointer">
                                    ...
                                    <div class="w-4.5 h-4.5 mt-0.5 border-2 border-neutral-500 rounded peer-checked:bg-[#F8931D] peer-checked:border-[#0f2a2e] transition-all flex items-center justify-center shrink-0">
                                        <svg class="w-3 h-3 text-white opacity-0 peer-checked:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
                                        </svg>
                                    </div>
                                    <span class="ml-2.5 text-[13px] text-neutral-600 leading-snug">
                                        I agree to the
                                        <a href="{{ route('terms') }}" class="text-[#0f2a2e] hover:text-[#091c1f] font-medium">Terms</a>
                                        and
                                        <a href="{{ route('privacy') }}" class="text-[#0f2a2e] hover:text-[#091c1f] font-medium">Privacy Policy</a>
                                    </span>
                                </label>
                            </div>
                        ...
                        <p class="mt-6 text-center text-sm text-neutral-600">
                            ...
                            <button @click="switchTo('login')" class="font-semibold text-[#0f2a2e] hover:text-[#091c1f] transition-colors">
                                Sign in
                            </button>
                        </p>
                    </div>
                ...
                <div class="mt-6 pt-4 border-t border-neutral-100 text-center">
                    <p class="text-xs text-neutral-600">
                        ...
                        <a href="{{ route('terms') }}" class="text-neutral-600 hover:text-[#0f2a2e] underline transition-colors">Terms</a>
                        &
                        <a href="{{ route('privacy') }}" class="text-neutral-600 hover:text-[#0f2a2e] underline transition-colors">Privacy Policy</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:block lg:w-1/2 relative overflow-hidden"
             x-data="{
                ...
                slides: [
                    {
                        bg: 'linear-gradient(135deg, #051012 0%, #091c1f 40%, #15383c 100%)',
                        tagline: 'Everything You Need',
                        subtitle: 'Discover great deals on gadgets, home essentials, beauty products, and everyday accessories',
                        icon: 'sparkles'
                    },
                    {
                        bg: 'linear-gradient(135deg, #091c1f 0%, #0f2a2e 40%, #205258 100%)',
                        tagline: 'Quality at Best Prices',
                        subtitle: 'Shop from thousands of products across electronics, home, health, and more',
                        icon: 'gem'
                    },
                    {
                        bg: 'linear-gradient(135deg, #051012 0%, #0f2a2e 40%, #1b454a 100%)',
                        tagline: 'Your One-Stop Shop',
                        subtitle: 'From home essentials to personal care, find it all in one place with fast delivery',
                        icon: 'palette'
                    }
                ],
                total: 3
