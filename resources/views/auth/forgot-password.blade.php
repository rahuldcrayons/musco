...
<body class="font-sans antialiased bg-white" x-data>
    ...
    <div class="min-h-[60vh] flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md mx-auto form-enter">
                ...
                @if (session('status'))
                    <div class="bg-[#202a40]/5 border border-[#202a40]/20 text-[#202a40] rounded-xl p-4 mb-5">
                ...
                <div x-data="otpReset()">
                    ...
                    <div x-show="step === 1" class="space-y-4">
                        <div>
                            ...
                            <input type="email" x-model="identifier" required autofocus
                        ...
                        <p x-show="error" x-text="error" class="text-sm text-[#CC0C39]" x-cloak></p>
                        <button @click="sendOtp()" :disabled="sending" type="button"
                                class="w-full py-2 px-4 bg-gradient-to-r from-[#202a40] to-[#222222] hover:from-[#222222] hover:to-[#D47200] text-white font-semibold rounded-xl transition-all disabled:opacity-50">
                            <span x-show="!sending">Send OTP</span>
                            <span x-show="sending">Sending...</span>
                        </button>
                        <p class="text-xs text-neutral-500 text-center">OTP will be sent to your email address</p>
                    </div>

                    {{-- Step 2: Enter OTP --}}
                    <div x-show="step === 2" x-cloak class="space-y-4">
                        <p class="text-sm text-neutral-600">OTP sent to <strong x-text="identifier"></strong>. Check your inbox.</p>
                        <div>
                        ...
                        <button @click="verifyOtp()" :disabled="verifying" type="button"
                                class="w-full py-2 px-4 bg-gradient-to-r from-[#202a40] to-[#222222] text-white font-semibold rounded-xl disabled:opacity-50">
                            <span x-show="!verifying">Verify OTP</span>
                            <span x-show="verifying">Verifying...</span>
                        </button>
                        <button @click="step=1;otp='';error=''" type="button" class="w-full text-sm text-[#202a40] hover:underline">Change email</button>
                    </div>

                    {{-- Step 3: Set new password --}}
                    <div x-show="step === 3" x-cloak class="space-y-4">
                        <div class="bg-[#202a40]/5 border border-[#202a40]/20 text-[#202a40] rounded-xl p-3 text-sm">OTP verified! Set your new password.</div>
                        <div>
