...
<body>
    <div class="header">
        <a href="{{ url('/') }}">
            <span style="font-family:'DM Sans',sans-serif; font-size:1.45rem; font-weight:700; letter-spacing:-0.02em; line-height:1;"><span style="color:#1e2a40;">Trendy</span><span style="color:#5a6e8a;">mus</span></span>
        </a>
    </div>
    <div class="content">
        <div class="card">
