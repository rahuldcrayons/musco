        ...
        @php
            ...
            $metaDesc = $metaCat
                ...
                : ($metaBrand
                    ...
                    : "Shop gadgets, home essentials, and accessories at " . config('app.name') . ". Browse {$products->total()} products with great deals.");
        @endphp
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        @if(request()->hasAny(['category', 'brand', 'min_price', 'max_price', 'rating', 'in_stock', 'on_sale']))
            <div class="flex flex-wrap items-center gap-2 mb-5">
                ...
                @endif
                @if(request('rating'))
                    <span class="inline-flex items-center px-2.5 py-1 bg-[#205258]/5 text-[#1b454a] text-xs font-medium rounded-full border border-[#205258]/30">
                ...
                @endif
                <a href="{{ route('products.index') }}" class="text-xs text-neutral-600 hover:text-[#205258] underline ml-1">Clear all</a>
            </div>
        @endif
            ...
            <div class="flex-1 min-w-0">
                ...
                @if($products->count())
                    ...
                    ">
                        ...
                        <div x-show="loading" x-cloak class="flex justify-center py-8">
                            <svg class="animate-spin h-6 w-6 text-[#205258]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                @else
                    <div class="text-center py-20">
                        ...
                        <a href="{{ route('products.index') }}" class="inline-flex items-center gap-2 px-4 py-1.5 bg-[#F8931D] hover:bg-[#E07E0A] text-white text-sm font-semibold rounded-lg transition-colors">
