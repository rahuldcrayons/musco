<form action="{{ route('products.index') }}" method="GET" class="space-y-4" id="filter-form">
    {{-- Preserve sort --}}
    @if(request('sort'))
                    ...
                    @foreach($categories as $category)
                        <label class="flex items-center gap-2.5 cursor-pointer group py-0.5">
                            <input type="radio" name="category" value="{{ $category->slug }}"
                                   ...
                                   class="w-3.5 h-3.5 border-neutral-300 text-[#202a40] focus:ring-[#202a40] focus:ring-offset-0"
            ...
            <div class="flex items-center gap-2 pt-1 pb-2">
                <div class="relative flex-1">
                    ...
                    <input type="number" name="min_price" value="{{ request('min_price') }}"
                           placeholder="Min"
                           class="w-full pl-6 pr-2 py-2 text-sm border border-neutral-200 rounded-lg focus:outline-none focus:border-[#202a40] bg-neutral-50">
                </div>
                ...
                @for($i = 4; $i >= 1; $i--)
                    <label class="flex items-center gap-2.5 cursor-pointer group py-0.5">
                        ...
                        <span class="flex items-center gap-0.5">
                            @for($j = 1; $j <= 5; $j++)
                                <svg class="w-3.5 h-3.5 {{ $j <= $i ? 'text-[#f5a623]' : 'text-neutral-200' }}" fill="currentColor" viewBox="0 0 20 20">
