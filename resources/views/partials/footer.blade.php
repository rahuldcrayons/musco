            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10">
                ...
                <div class="col-span-2 lg:col-span-2">
                    <a href="{{ url('/') }}" class="flex items-center gap-2 mb-4">
                        ...
                        @else
                            <img src="{{ asset('images/jikra-logo.png') }}" alt="Jikra" class="h-auto w-24 object-contain">
                        @endif
                    </a>
                    <p class="text-gray-500 text-sm mb-5 leading-relaxed max-w-sm">
                        {{ $footerAbout }}
                    </p>
                    <!-- Social Icons -->
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        ...
                        <li><a href="{{ route('size-guide') }}" class="text-gray-500 hover:text-gray-900 transition-colors">Size Guide</a></li>
                    </ul>
                </div>
