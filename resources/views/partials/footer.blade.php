            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10">
                ...
                <div class="col-span-2 lg:col-span-2">
                    ...
                    <div class="flex gap-3">
                        @php
                            ...
                            $socialInstagram = \App\Models\Setting::get('social_instagram', 'https://www.instagram.com/jikraoffical');
                        ...
                        @endphp
                        @if($socialFacebook)
                            <a href="{{ $socialFacebook }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="Facebook" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                        @endif
                        @if($socialInstagram)
                            <a href="{{ $socialInstagram }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="Instagram" target="_blank">
                        ...
                        @endif
                        @if($socialTwitter)
                            <a href="{{ $socialTwitter }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="X (Twitter)" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            </a>
                        @endif
                        @if($socialYoutube)
                            <a href="{{ $socialYoutube }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="YouTube" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            </a>
                        @endif
                        @if($socialTiktok)
                            <a href="{{ $socialTiktok }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="TikTok" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
                            </a>
                        @endif
                        @if($socialPinterest)
                            <a href="{{ $socialPinterest }}" class="w-9 h-9 bg-white/10 hover:bg-[#205258] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="Pinterest" target="_blank">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('about') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">About Us</a></li>
                        <li><a href="{{ route('contact') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Contact Us</a></li>
                        <li><a href="{{ route('faq') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">FAQs</a></li>
                        <li><a href="{{ route('blog') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Blog</a></li>
                        <li><a href="{{ route('careers') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Careers</a></li>
                        <li><a href="{{ route('size-guide') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Size Guide</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('help') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Help Center</a></li>
                        <li><a href="{{ route('track-order') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Track Order</a></li>
                        <li><a href="{{ route('returns') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Returns & Refunds</a></li>
                        <li><a href="{{ route('shipping') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Shipping Info</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('privacy') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Privacy Policy</a></li>
                        <li><a href="{{ route('terms') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Terms of Service</a></li>
                        <li><a href="{{ route('cookie-policy') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">Cookie Policy</a></li>
                        <li><a href="{{ route('gdpr') }}" class="text-neutral-300 hover:text-[#205258] transition-colors">GDPR Compliance</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="border-t border-white/10 py-8">
        <div class="container mx-auto px-4">
            <div class="max-w-xl mx-auto text-center" x-data="{ email: '', submitted: false, error: '' }">
                ...
                <p class="text-xs text-neutral-300 mb-3">Get the latest deals, new arrivals & style tips straight to your inbox.</p>
                ...
                " class="flex items-stretch gap-2 max-w-md mx-auto">
                    <input type="email" x-model="email" required placeholder="Your email address"
                           class="flex-1 min-w-0 text-sm px-4 py-2.5 bg-white/10 border border-white/10 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:border-[#205258]">
