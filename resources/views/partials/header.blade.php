    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-14 lg:h-16">
            ...
            <a href="{{ url('/') }}" class="flex items-center shrink-0">
                ...
                @if($siteLogo)
                    <img src="{{ asset('storage/' . $siteLogo) }}" alt="{{ config('app.name') }}" class="h-7 lg:h-9 w-auto max-w-[100px] lg:max-w-none">
                @else
                    <img src="{{ asset('images/jikra-logo.png') }}" alt="Jikra" class="h-7 lg:h-9 w-auto max-w-[100px] lg:max-w-none">
                @endif
            </a>
