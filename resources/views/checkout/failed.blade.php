            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('checkout.index') }}"
                       class="flex-1 inline-flex items-center justify-center gap-2 py-2 px-4 bg-[#202a40] text-white text-sm font-semibold rounded-xl transition-colors">
                ...
                <div class="mt-8 text-center">
                    <p class="text-xs text-neutral-600">
                        Need help? <a href="{{ route('contact') }}" class="text-[#202a40] hover:underline">Contact our support team</a>
                    </p>
                </div>
