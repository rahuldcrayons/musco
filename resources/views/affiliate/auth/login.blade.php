    ...
    <div class="min-h-[70vh] flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <form method="POST" action="{{ route('affiliate.login') }}" class="space-y-4">
                ...
                <button type="submit" class="w-full py-2.5 px-4 bg-[#202a40] text-white font-medium text-sm rounded-lg border border-[#202a40] transition-colors">
                    Sign in
                </button>
            </form>
