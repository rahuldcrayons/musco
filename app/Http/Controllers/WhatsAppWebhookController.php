...
class WhatsAppWebhookController extends Controller
{
    ...
    {
        $verifyToken = config('services.whatsapp.verify_token', 'jikra_whatsapp_verify_2026');
